...
ATile::ATile()
{
	...
	MinExtent = FVector(0, -2000, -155);
	MaxExtent = FVector(4000, 2000, -155);
	NavigationBoundsOffset = FVector(2000, 0, 0);
}

void ATile::PlaceActors(TSubclassOf<AActor> ToSpawn, int MinSpawn,
	int MaxSpawn, float Radius, float MinScale, float MaxScale)
{
